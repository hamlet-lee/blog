...
客户端这样写连接串
```text
String connStr = "jdbc:presto://host_in_inner_net:8889/hive?socksProxy=proxyhost:proxyport&SSL=true&SSLTrustStorePath=client.keystore.jks&SSLTrustStorePassword=xxx";
```
